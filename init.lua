...
-- Autosave when focus of window is lost
vim.api.nvim_create_autocmd('FocusLost', {
  desc = 'Autosave when focus of window is lost.',
  callback = function()
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', function()
        live_grep_args_shortcuts.grep_visual_selection { postfix = ' -F packages' }
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>yd', require('telescope.builtin').lsp_document_symbols, 'S[y]mbols of [D]ocument')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('<leader>yw', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'S[y]mbols of [W]orkspace')
      ...
      -- Configure each server via the new vim.lsp.config API (Nvim 0.11+)
